...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir D:/Programs/lab-digital-logic/test_project/test_project.runs/clk_div_synth_1 -new_name clk_div -ip [get_ips clk_div]]

if { $cached_ip eq {} } {
close [open __synthesis_is_running__ w]

synth_design -top clk_div -part xc7z020clg400-2 -mode out_of_context
