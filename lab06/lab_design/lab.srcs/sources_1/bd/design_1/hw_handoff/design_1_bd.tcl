...
proc create_root_design { parentCell } {
  ...
  set P [ create_bd_port -dir O -from 63 -to 0 -type data P ]
  ...
  connect_bd_net -net clk_wiz_clk_out1 [get_bd_pins clk_wiz/clk_out1] [get_bd_pins mult_gen_0/CLK]
  connect_bd_net -net mult_gen_0_P [get_bd_ports P] [get_bd_pins mult_gen_0/P]
  connect_bd_net -net reset_rtl_0_1 [get_bd_ports rst] [get_bd_pins clk_wiz/reset]
